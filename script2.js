...
function validateForm(ev) {
    ...
    var password = document.getElementById("password").value; // <-- Add this line
    ...
    if (age.length == 0 || isNaN(age) ) {
        ...
        document.querySelector(".errAge").innerHTML = "<p style='color:red;font-size:11px'>Le mot de passe doit contenir des nombre.</p>"
    } else {
        document.querySelector(".errAge").innerHTML = ""
    }
...
document.getElementById("btn2").addEventListener("click", function() {
    var generated = generatePasswordASCII(10);
